...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-customerchannel';
        ...
        */
        ...
        return view('customerchannel::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('customerchannel.name'),
            'version' => config('settings.global.customerchannel_version')??config('customerchannel.version'),
            'is_dev' => config('customerchannel.is_dev'),
        ];
        ...
        $data['versions'] = [
            ...
            'app_version' => config('app.version','0.23.65'),
        ];
