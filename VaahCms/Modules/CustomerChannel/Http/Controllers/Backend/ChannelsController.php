...
use VaahCms\Modules\CustomerChannel\Models\Channel;
...
class ChannelsController extends Controller
{
    ...
    public function getAssets(Request $request)
    {
        ...
        try{
            ...
            $data['locale'] = Taxonomy::getTaxonomyByType('locale');
            $data['currency'] = Taxonomy::getTaxonomyByType('currency');
            $data['type'] = Taxonomy::getTaxonomyByType('type');
            $data['customers']=Channel::getCustomerNames();
    ...
    {
        try{
            Channel::checkPermission('customerchannel-can-delete-channel');
    ...
    {
        try{
            return Channel::autoCompleteSearch($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Channel::getCustomerNames();
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
