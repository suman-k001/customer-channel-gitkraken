...
let model_namespace = 'VaahCms\\Modules\\CustomerChannel\\Models\\Product';


let base_url = document.getElementsByTagName('base')[0].getAttribute("href");
let ajax_url = base_url + "/customerchannel/products";
...
export const useProductStore = defineStore({
    ...
    actions: {
        ...
        watchStates() {
            ...
            watch(this.product_users_query, (newVal, oldVal) => {
                this.delayedProductUsersSearch();
            }, {
                deep: true
            });
        },
        ...
        afterGetList: function (data, res) {
            ...
            this.total_users = res.data.totalUser;
        },
        //---------------------------------------------------------------------
        ...
        async getItemUsers() {
            ...
            let params = {
                query: this.product_users_query,
                method: 'get',
            };
        ...
        async userPaginate(event) {
            this.product_users_query.page = event.page+1;
        ...
        resetProductUserFilters() {
            this.product_users_query.q = null;
        },
        async getProductUserMenuItems() {
            this.product_user_menu_items = [
                {
