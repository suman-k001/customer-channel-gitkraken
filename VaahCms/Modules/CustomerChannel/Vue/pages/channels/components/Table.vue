...
<template>
    ...
    <div v-if="store.list">
        ...
        <DataTable :value="store.list.data"
            ...
            <Column field="customers.name" header="Customer"/>
            ...
            <Column field="is_active" v-if="store.isViewLarge()"
                ...
                <template #body="prop">
                    <InputSwitch v-model.bool="prop.data.is_active"
                                 ...
                                 :disabled="!store.hasPermission('customerchannel-can-delete-channel')"
            ...
            <Column field="actions" style="width:150px;"
                ...
                <template #body="prop">
                    <div class="p-inputgroup ">
                        ...
                        <template v-if="store.hasPermission('customerchannel-can-delete-channel')">
